    ...
    <div>
      ...
      <div className="title-page-header">
        ...
        <div id="info">
          ...
          types of securities to invest in, you can make more confident
          decisions of where to put your money.
          <br></br>
          <br></br>
          ...
          all securities sold to the public be registered with the SEC
          (Securities and Exchange Commission), and that complete information
          about the seller and the security be made available to the investor.
        </div>
        ...
        <div id="info">
          ...
          <b>ownership of a fraction of a company.</b> By purchasing a stock of
          a company, as the company succeeds and grows, the value of your stock
          grows with it.
          <img id="icons" src={pie} alt="pie" />
          Investors can then <b>sell their stock at a greater price</b> than
          they bought it for, thus making a profit.
        </div>
        ...
        <div id="info">
          ...
          By selling their stock, the company can afford various initiatives
          such as <b>opening a new branch, </b> or <b>paying off a debt.</b>
          <br></br>
          <br></br>
          <Quiz9 />
          <br></br>
        ...
        <div id="info">
          ...
          <b>go down.</b> If that same company starts doing <b>well</b> again,
          its stock price will <b>go back up.</b>
          <img id="icons" src={yikes} alt="yikes" />
          <br></br>
          Investing in stocks is therefore <b>not a guaranteed win.</b> But
          don't let this scare you away from stocks because as mentioned, the
          average annual stock market return after inflation is about <b>8%.</b>
        </div>
        ...
        <div id="info">
          Another type of security are <b>bonds.</b> If a corporation needs
          funds to grow their business or a government needs funds to build
          roads, they can <b>raise these funds by issuing bonds.</b>
          <br></br>
          <br></br>
        ...
        <div id="info">
          Investors buy bonds because they provide a <b>predictable return</b>{' '}
          via a steady stream of income from interest payments. Purchasing bonds
          is therefore considered a <b>low risk investment.</b>
          <br></br>
          <br></br>
          But lower risk investments also have <b>lower returns.</b>{' '}
          Historically, the average return from bond investments are lower than
          ...
          <Quiz12 />
          <br></br>
          Understanding what you can invest in will give you a leg up when
