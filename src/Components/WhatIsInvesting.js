...
export default function WhatIsInvesting(props) {
  return (
    <div className="title-page-header">
      ...
      <div id= 'info'>
          Assume you buy a board game for <b>$200.</b> Fifteen years later, it is worth <b>$1,000</b> because of the sentimental value that it creates. The board game has <b>appreciated</b>, and your money spent then is worth 5 times as much now.
          <br></br>
          <br></br>
          The same goes for <b>investing</b> in securities such as stocks and bonds (we will cover securities later). You buy a stock, watch it <b>appreciate</b>, and then sell it for more money than you bought it for, i.e. a profit.
      </div>
      <div className = 'section'>
          <b>Make Money While Sleeping</b>
      </div>
      <div id = 'info'>
          The best part is, investing <b>does not require a lot of work.</b> It can be very easy and you don't have to put a lot of time into it.
          <br></br>
          <br></br>
          It is so easy, that you can even <b>make money while you sleep!</b> How great is that?!
      ...
      <div id="info">
          ...
          <br></br>
          <br></br>
          There is always a chance that you lose money if the value of your investments <b>depreciates.</b>
          <img id='icons' src = {roadBlock} alt='roadblock' />
          But don't worry, you are <b>on the right track</b> to make more informed investment decisions!
          <br></br>
          <br></br>
