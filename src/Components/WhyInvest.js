...
export default function WhyInvest(props) {
  return (
    <div className="title-page-header">
      ...
      <div id="info">
        Inflation is a rise of the prices of goods and services which leads to a{' '}
        <b>decrease in purchasing power.</b> Since 1990, the inflation rate has
        been on average <b>2.4%.</b>
        <br></br>
        <br></br>
      ...
      <div id="info">
        ...
        <b>$100</b> bill that you might have in your wallet this year will only
        be worth <b>$78.89</b> in 10 years.
        <br></br>
        <br></br>
        <InflationCalc />
        <br></br>
      ...
      <div id="info">
        ...
        The historical average annual stock market return is said to
        be <b> 10%. </b>With an average of 2.4% inflation, this leaves us with
        an average of almost <b> 8% increase in returns!</b>
        <br></br>
        <br></br>
        <Quiz6 />
        <br></br>
